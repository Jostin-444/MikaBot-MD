  ...
  if (args[1]) {
	 setTimeout(async () => {
      await conn.groupSettingUpdate(m.chat, `${isClose == 'announcement' ? 'not_announcement' : 'announcement'}`).then(async (_)=>{
		    conn.reply(m.chat, `${isClose == 'not_announcement' ? '*Aviso*

> 𝗘𝗹 𝗴𝗿𝘂𝗽𝗼 𝗵𝗮 𝘀𝗶𝗱𝗼 𝗰𝗲𝗿𝗿𝗮𝗱𝗼, ¡𝗮𝗵𝗼𝗿𝗮 𝘀𝗼𝗹𝗼 𝗹𝗼𝘀 𝗮𝗱𝗺𝗶𝗻𝗶𝘀𝘁𝗿𝗮𝗱𝗼𝗿𝗲𝘀 𝗽𝘂𝗲𝗱𝗲𝗻 𝗲𝗻𝘃𝗶𝗮𝗿 𝗺𝗲𝗻𝘀𝗮𝗷𝗲𝘀!!' : '*Aviso*

> 𝗘𝗹 𝗴𝗿𝘂𝗽𝗼 𝗵𝗮 𝘀𝗶𝗱𝗼 *abierto*, ¡𝗮𝗵𝗼𝗿𝗮 𝘀𝗼𝗹𝗼 𝗹𝗼𝘀 𝗮𝗱𝗺𝗶𝗻𝗶𝘀𝘁𝗿𝗮𝗱𝗼𝗿𝗲𝘀 𝗽𝘂𝗲𝗱𝗲𝗻 𝗲𝗻𝘃𝗶𝗮𝗿 𝗺𝗲𝗻𝘀𝗮𝗷𝗲𝘀!!!'}!`);
	    });
    }, timeoutset);
  }
};
