...
global.authFile = `MikaSession`
global.authFileJB = `MikaJadiBot`
...
mobile: MethodMobile, 
browser: opcion == '1' ? ['MikaBot-MD', 'Edge', '2.0.0'] : methodCodeQR ? ['MikaBot-MD', 'Edge', '2.0.0'] : ['Ubuntu', 'Edge', '110.0.1587.56'],
auth: {
creds: state.creds,
...
const mainBotAuthFile = 'MikaSession';
try {
